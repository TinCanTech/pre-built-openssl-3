    ...
    "dirinfo" => {
        ...
        "crypto/bn" => {
            "deps" => [
                ...
                "crypto/bn/liblegacy-lib-rsaz-avx512.o",
...
unless (caller) {
    ...
    use lib '/home/tct/git/tct/pre-built-openssl-3/util/perl';
    use OpenSSL::fallback '/home/tct/git/tct/pre-built-openssl-3/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/tct/git/tct/pre-built-openssl-3/Configurations';
        use gentemplate;
